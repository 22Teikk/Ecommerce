...
{
    public partial class ProductComponentPage : System.Web.UI.Page
    {
        ...
        {
            dtgProduct.DataSource = data.listProductByCategoryName("Phụ kiện");
            dtgStock.DataSource = data.listProductStock("Phụ kiện");
            dtgOutStock.DataSource = data.listProductOutStock("Phụ kiện");
            DataBind();
        }
