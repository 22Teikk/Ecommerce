<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPageMaster.Master" AutoEventWireup="true" CodeBehind="DetailCategoryPage.aspx.cs" Inherits="FinalExamGroup8.DetailCategoryPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pagetitle">
        <% FinalExamGroup8.model.Category category = Session["category"] as FinalExamGroup8.model.Category; %>
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="CategoryPage.aspx">Danh sách danh mục</a></li>
